...
class Drift(Element):
    ...
    def slice(self, slice_length: float) -> None:
        ...
        base_slice = self.create_slice(s_l_a)
        self.slices = [base_slice] * num_slices
        if r_l_s > 0.0:
...
class Dipole(Element):
    __slots__ = ("gap", "k1in", "k1ex", "k2in", "k2ex", "bending_angle", "entrance_angle", "exit_angle", "_rho_cache")
